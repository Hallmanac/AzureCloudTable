...
namespace HallmanacAzureTable.EventStore
{
    public class AzureTableContext<TEntity> where TEntity : ITableEntity, new()
    {
        ...
        public TEntity TableRowInstance { get; set; }
        ...
        // public GetStreamingQuery --> idea that popped into my head for getting a stream of Table Entities that
        // can be queried via Linq to Objects.
