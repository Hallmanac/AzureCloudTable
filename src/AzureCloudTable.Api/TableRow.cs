...
namespace AzureCloudTableContext.Api
{
    ...
    internal class TableRow<TDomainObject> : ITableEntity where TDomainObject : class, new()
    {
        ...
        private static EntityProperty CreateEntityPropertyFromObject(object value, bool allowUnknownTypes)
        {
            ...
            if(allowUnknownTypes)
            {
                ...
                throw new TableRowEntityPropertySizeException(
    ...
    [Serializable]
    internal class TableRowEntityPropertySizeException : ApplicationException
    {
        public TableRowEntityPropertySizeException() {}

        public TableRowEntityPropertySizeException(string message, string entity)
            : base(message)
        {
            Entity = entity;
        }
